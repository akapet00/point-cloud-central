...
def estimate_normals(
    ...
    A tightly tapered 224-neighbor Gaussian tail initializes the provisional
    tangent. Two Tukey-biweight IRLS steps refine that normal; their
