...
def estimate_normals(
    ...
    positional noise. Tukey-biweight refinements then use a local 112-point
    correction and a 128-point final covariance; the final residual location
    and scale come from an 80-neighbor core to limit tail-induced bias.
    """
    del query_indices
