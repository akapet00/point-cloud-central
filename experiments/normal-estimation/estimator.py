...
def estimate_normals(
    ...
    for start in range(0, neighbor_indices.shape[0], BATCH_SIZE):
        ...
        for step, parameters in enumerate(fit_parameters):
            tukey_cutoff, refinement_count, location_count, scale_count = parameters
