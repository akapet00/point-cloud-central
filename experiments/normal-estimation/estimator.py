...
def estimate_normals(
    ...
    final 128-point covariance uses robust location from its nearest 64
    samples and scale from its nearest 48, limiting curvature-inflated scale.
    """
    del query_indices
    ...
    for start in range(0, neighbor_indices.shape[0], BATCH_SIZE):
        ...
        location_counts = (NEIGHBOR_COUNT, FINAL_STATISTIC_COUNT)
