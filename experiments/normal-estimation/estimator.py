...
def estimate_normals(
    ...
    positional noise. A 112-neighbor Tukey fit first corrects that plane, then
    a 160-neighbor Tukey fit adds a decaying tail for noise averaging while
