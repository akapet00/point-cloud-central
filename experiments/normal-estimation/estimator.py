...
def estimate_normals(
    ...
    leverage. The first refinement uses a slightly narrower 108-neighbor
    Gaussian bandwidth to limit bias from its added covariance tail.
    """
    del query_indices
    ...
    for start in range(0, neighbor_indices.shape[0], BATCH_SIZE):
        ...
        for tukey_cutoff, refinement_count, bandwidth_count, statistic_count in zip(
            ...
            if bandwidth_count == NEIGHBOR_COUNT:
