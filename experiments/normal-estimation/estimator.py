...
def estimate_normals(
    ...
    the final 128-neighbor covariance estimates its robust residual statistics
    from a query-local 96-neighbor core to limit tail-induced bias.
    """
    del query_indices
