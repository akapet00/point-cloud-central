...
NEIGHBOR_COUNT = 112
FIRST_LOCATION_COUNT = 24
FIRST_SCALE_COUNT = 32
...
def estimate_normals(
    ...
    first pass estimates location from 24 samples and scale from 32, while
    the final pass uses 32 for both so curved tail points cannot set leverage.
    """
    del query_indices
