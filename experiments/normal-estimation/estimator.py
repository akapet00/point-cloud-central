...
ROBUST_STATISTIC_COUNTS = (112, 128)
MAD_TO_SIGMA = 1.4826
BATCH_SIZE = 2_048
...
def estimate_normals(
    ...
    corrected plane admits a 160-neighbor tail for the final covariance while
    its robust location and scale remain localized to the nearest 128 points.
    """
    del query_indices
