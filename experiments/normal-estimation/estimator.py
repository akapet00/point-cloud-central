...
def estimate_normals(
    ...
    112- and 128-point covariances use query-local robust statistics so curved
    tail points cannot define their own leverage. In the first pass, location
    uses 32 samples while scale uses a more local 24-sample core.
    """
    del query_indices
