...
def estimate_normals(
    ...
    A 224-neighbor Gaussian tail with 120-neighbor bandwidth stabilizes the
    provisional tangent under positional noise. Two Tukey-biweight IRLS steps
    refine that normal; their 120- and 128-point covariances use robust location
    and scale from the
