...
def estimate_normals(
    ...
    positional noise. A 112-neighbor Tukey correction removes extreme
    residuals before a 144-neighbor final fit adds a decaying noise-averaging
    tail without broadening the Gaussian bandwidth.
    """
    del query_indices
