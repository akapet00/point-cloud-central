...
- `notes.md` — concise findings, guidance, and precise prior failure stages;
...
Choose one untested conceptual hypothesis using `notes.md`, `condition-memory.md`, and the complete quantitative history. State which conditions should improve and which may regress. It must address a recognizable issue—noise, curvature, density, outliers, or neighborhood bias—and admit a short mathematical explanation and independent ablation.
