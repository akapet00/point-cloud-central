...
- `qualitative-errors.png`: illustrative sharp-feature angular-error maps from the frozen analysis.
- `figures/`: publication-ready exports regenerated by the analysis notebook with larger typography and markers.
